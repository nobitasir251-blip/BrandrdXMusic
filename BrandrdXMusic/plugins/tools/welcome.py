...
๏ 𝐌𝐀𝐃𝐄 𝐁𝐘 ➠ [༄ ᭄ ℕ𝕆𝔹𝕀𝕋𝔸 ࿐](https://t.me/NOBITA_0009)
➖➖➖➖➖➖➖➖➖➖➖
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/JINAL_MUSICBOT?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
